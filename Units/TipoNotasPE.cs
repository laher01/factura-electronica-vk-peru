...
namespace Factura_Electronica_VK.TipoNotasPE
{
    class TTipoNotasPE : TvkBaseForm, IvkFormInterface
    {
        ...
        private Boolean LimpiarGrid()
        {
            ...
            try
            {
                ...
                while (i < oDataTable.Rows.Count)
                {
                    ...
                    else if ((System.String)(oDataTable.GetValue("U_TypeCode", i)).ToString().Trim() == "")
                    {
                        oDataTable.Rows.Remove(i);
                        i = i - 1;
                    }
        ...
        private Boolean CrearDatos()
        {
            ...
            try
            {
                ...
                if (oRecordSet.RecordCount > 0)
                    Functions.PENotesDel(ref oRecordSet);
                ...
                while (i < oDataTable.Rows.Count)
                {
                    ...
                    oDBDSHeader.SetValue("U_TypeCode", 0, (System.String)(oDataTable.GetValue("U_TypeCode", i)).ToString().Trim());

                    _result = Functions.PENotesAdd(oDBDSHeader);
