--DROP PROCEDURE VID_SP_FE_IN_ED_PE_Genera03E;
CREATE PROCEDURE VID_SP_FE_IN_ED_PE_Genera03E
(
     IN DocEntry	Integer
...
BEGIN
		...
		SELECT :TipoDoc					"TipoDocumento"
			  ...
			  ,CASE WHEN LEFT(T0."externalFolio",1) = 'F' THEN T0."externalFolio" ELSE 'B' || T0."externalFolio" END	"IdDocumento" --FF11-004
